...
/** Callable object representing a function that either _reads_ or _writes_ the state at a given _path_. When invoked, returns an instance of {@linkcode State}. */
export default class Operation extends Callable {
  /** The _path_ associated with the operation. */
  path: string;
   ...
   */
  constructor(path: string, func: Function, isRead: boolean, dependents = [], dependencies = []) {
    super(async (args) => {
      let result: State;
